...
//PHP Analyzer
$route['admin/facebook/(:any)'] = 'adminarea/facebook_user/$1';
$route['admin/facebook/exportCSV/(:any)'] = 'adminarea/exportCSV/$1';
$route['admin/facebookuserajax']['post'] = 'adminarea/facebook_user_ajax';
