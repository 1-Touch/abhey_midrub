<nav>
    <ul>
        ...
        <li<?php //if ( function_exists('md_the_component_variable') ): if ( md_the_component_variable('component_slug') === 'phpanalyzer' ): echo ' class="active"'; endif; endif; ?>>
            <!-- <a href="<?php //echo site_url('admin/facebook') ?>">
                <i class="icon-settings"></i><br>
                <?php //echo "Facebook"; ?>
            </a> -->
        </li>
