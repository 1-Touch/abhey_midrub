...
<script src="<?php echo base_url(); ?>assets/js/common.min.js"></script>
 ...
 <script src="<?php echo base_url(); ?>assets/plugins/flot/js/jquery.flot.min.js"></script>
    <script src="<?php echo base_url(); ?>assets/plugins/flot/js/jquery.flot.pie.js"></script>
    <script src="<?php echo base_url(); ?>assets/plugins/flot/js/jquery.flot.resize.js"></script>
    <script src="<?php echo base_url(); ?>assets/plugins/flot/js/jquery.flot.spline.js"></script>
    <script src="<?php echo base_url(); ?>assets/plugins/flot/js/jquery.flot.init.js"></script>
